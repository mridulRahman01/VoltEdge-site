    ...
    <div>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {['ASUS', '16GB RAM', '৳1L–৳2L']?.map((chip) => (
          <span
            key={chip}
            className="inline-flex items-center gap-1.5 px-3 py-1.5 min-h-[36px] rounded-full bg-accent/10 border border-accent/30 text-accent text-xs font-medium"
          >
            {chip}
            <button
              className="hover:text-danger transition-colors p-0.5 touch-manipulation"
